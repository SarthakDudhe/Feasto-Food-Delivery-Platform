  ...
  return (
    <>
      <div className='navbar'>
        <Link to={"/"}><img src={assets.Feasto} alt="" className="logo" /></Link>
        ...
        <div className="mobile-drawer-overlay" onClick={() => setIsMobileOpen(false)}>
          <div className="mobile-drawer-card" onClick={(e) => e.stopPropagation()}>
            <div className="drawer-header">
              <img src={assets.Feasto} alt="Feasto" className="drawer-logo" />
              <button className="btn-close-drawer" onClick={() => setIsMobileOpen(false)}>✕</button>
            </div>
            <nav className="drawer-links">
              <Link to="/" onClick={() => { setMenu("home"); setIsMobileOpen(false); }}>Home 🏠</Link>
